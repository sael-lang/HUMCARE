...
class ProfilePage extends React.Component {
    ...
    render(){
        return <>
                <div className="my-3 p-3 bg-body rounded shadow-sm">
                    <h6 className="border-bottom pb-2 mb-0 mb-3">Add Room</h6>
                        <form onSubmit={this.handleButtonClick}>
                            <div className="row">
                                ...
                                <div className="col">
                                    <label htmlFor="exampleInputEmail1" className="form-label">Available</label>
                                    <div className="input-group mb-3">
                                        <input type="text"  name="available" onChange={this.handleClick} className="form-control" placeholder="available" aria-label="Recipient's username" aria-describedby="basic-addon2"/>
                                    </div>
                                </div>
                            </div>
                            <div className="row">
                                <div className="col">
                                    <label htmlFor="exampleInputEmail1" className="form-label">Patient Assigned</label>
                                    <div className="input-group mb-3">
  ...
  <div className="input-group mb-3">
      ...
      />
                            ...
                            <div className="row">
                                <div className="col">
                                    <label htmlFor="exampleInputEmail1" className="form-label">Room Detail </label>
                                    <div className="input-group mb-3">
                                        <input type="text" name="timeavailable" onChange={this.handleClick} className="form-control" placeholder="Room Detail" aria-label="Recipient's username" aria-describedby="basic-addon2"/>
                                        <span className="input-group-text" id="basic-addon2"><i className="fa fa-user"></i></span>
                                    </div>
                                </div>
                                <div className="col">
